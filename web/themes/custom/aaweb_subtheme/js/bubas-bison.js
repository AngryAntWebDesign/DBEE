...
// UNCOMMNET TO DO 
    ...
    info.update = function(props) {
      ...
      if(props) {
      presence = (props.season_Bubas_Bison_Yr == 1) ?  'PRESENT - ' :  'NOT PRESENT';
      presence_a = (props.season_Bubas_Bison_A == 1) ? 'Autum' : '';
      presence_w = (props.season_Bubas_Bison_W == 1) ? 'Winter' : '';
      presence_s = (props.season_Bubas_Bison_S == 1) ?  'Summer' : '';
      presence_sp = (props.season_Bubas_Bison_Sp == 1) ? 'Spring' : '';
      }
      this._div.innerHTML =
        "<h4>" + conceptName + "</h4>" +
        (props
