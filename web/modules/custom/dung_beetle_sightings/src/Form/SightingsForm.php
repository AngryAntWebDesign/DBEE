...
/**
 * Form controller for Sightings edit forms.
 *
 * @ingroup dung_beetle_sightings
 */
class SightingsForm extends ContentEntityForm {
  ...
  /**
   * Constructs a new SightingsForm.
   *
  ...
  public function save(array $form, FormStateInterface $form_state) {
    ...
    switch ($status) {
      case SAVED_NEW:
        $this->messenger()->addMessage($this->t('Created the %label Sightings.', [
          '%label' => $entity->label(),
        ]));
        break;

      default:
        $this->messenger()->addMessage($this->t('Saved the %label Sightings.', [
          '%label' => $entity->label(),
        ]));
    }
    $form_state->setRedirect('entity.sightings.canonical', ['sightings' => $entity->id()]);
  }
