...
use Drupal\dung_beetle_sightings\Entity\Sightings;


/**
 * Provides dynamic permissions for Sightings of different types.
 *
 * @ingroup dung_beetle_sightings
 *
 */
class SightingsPermissions{
   ...
   *
   * @return array
   *   The Sightings by bundle permissions.
   *   @see \Drupal\user\PermissionHandlerInterface::getPermissions()
   */
  public function generatePermissions() {
    $perms = [];

    foreach (Sightings::loadMultiple() as $type) {
   ...
   *
   * @param \Drupal\dung_beetle_sightings\Entity\Sightings $type
   *   The Sightings type.
   *
   * @return array
   *   An associative array of permission names and descriptions.
   */
  protected function buildPermissions(Sightings $type) {
    $type_id = $type->id();
